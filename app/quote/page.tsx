        ...
        <div className="py-20 bg-gray-50">
          <div className="max-w-2xl mx-auto px-6 text-center">
            <div className="bg-white rounded-lg shadow-xl p-12">
              ...
              <h1 className="text-3xl font-bold text-black mb-4">Bedankt voor uw aanvraag!</h1>
              <p className="text-xl text-gray-600 mb-8">
                Uw offerteaanvraag is succesvol verzonden. Wij nemen binnen 24 uur contact met u op 
                om uw project te bespreken en een gepersonaliseerde offerte op te stellen.
              </p>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="name" className="text-black font-medium">Naam *</Label>
                      <Input 
                        id="name" 
                        name="name" 
                        required 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-black font-medium">Telefoonnummer *</Label>
                    <Input 
                      id="phone" 
                      name="phone" 
                      type="tel" 
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="space-type" className="text-black font-medium">Soort ruimte *</Label>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="surface-area" className="text-black font-medium">Oppervlakte (m²) *</Label>
                      <Input 
                        id="surface-area" 
                        name="surface-area" 
                        type="number" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tile-type" className="text-black font-medium">Gewenst type tegel</Label>
                    <Select name="tile-type">
                      <SelectTrigger className="border-gray-300 focus:border-[#7ED321] focus:ring-[#7ED321]">
                        <SelectValue placeholder="Selecteer tegel type (optioneel)" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="ventilated">Geventileerde PVC-tegels</SelectItem>
                        <SelectItem value="smooth-light">Gladde kliktegels (lichte belasting)</SelectItem>
                        <SelectItem value="smooth-heavy">Gladde kliktegels (zware belasting)</SelectItem>
                        <SelectItem value="led-lighting">Met LED-verlichting</SelectItem>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <Label htmlFor="installation" className="text-black font-medium">
                    ...
                    <div className="flex items-center space-x-3">
                      <Checkbox 
                        ...
                        className="border-gray-300 data-[state=checked]:bg-[#7ED321] data-[state=checked]:border-[#7ED321]"
                      />
                      <Label htmlFor="lighting" className="text-black font-medium">
                    ...
                    <div className="flex items-center space-x-3">
                      <Checkbox 
                        ...
                        className="border-gray-300 data-[state=checked]:bg-[#7ED321] data-[state=checked]:border-[#7ED321]"
                      />
                      <Label htmlFor="painting" className="text-black font-medium">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="additional-info" className="text-black font-medium">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <Label htmlFor="privacy" className="text-sm text-gray-600 leading-relaxed">
                      ...
                      PowerTiles respecteert uw privacy en gebruikt uw gegevens uitsluitend voor dit doel. *
                    </Label>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  ...
                  <p className="text-sm text-gray-500 text-center mt-4">
                    U ontvangt binnen 24 uur een gepersonaliseerde offerte van ons team
                  </p>
                </div>
              </form>
            </CardContent>
